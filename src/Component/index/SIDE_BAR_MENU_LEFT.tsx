             ...
             <div className="middle-sidebar-left">
                    <div className="row">
                        <div className="col-lg-12 mb-3">
                            <div className="card rounded-xxl p-lg--5 border-0 bg-no-repeat bg-image-contain" style={{backgroundPosition: 'right 50px top 10px', backgroundColor: '#e4f7fe', backgroundImage: 'url(https://via.placeholder.com/1250x450.png)'}}>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-5">
                                                <div className="form-group icon-input mb-0">
                                                    ...
                                                    <input type="text" className="style1-input bg-transparent border-0 pl-5 font-xsss mb-0 text-grey-500 fw-500" placeholder="Search online courses.."/>
                                                </div>
                                            </div>
                                ...
                                <div className="item">
                                    <div className="card w200 d-block border-0 shadow-xss rounded-lg overflow-hidden mb-4">
                                        ...
                                        <div className="card-body d-block w-100 pl-4 pr-4 pb-4 text-center">
                                            ...
                                            <span className="live-tag mt-2 mb-3 bg-danger p-2 z-index-1 rounded-lg text-white font-xsssss text-uppersace fw-700 ls-3">LIVE</span>
                                        </div>
                                    </div>
                                </div>
