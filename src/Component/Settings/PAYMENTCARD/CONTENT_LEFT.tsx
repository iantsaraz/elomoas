                    ...
                    <div className="middle-wrap">
                        <div className="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div className="card-body p-4 w-100 bg-current border-0 d-flex rounded-lg">
                                ...
                                <h4 className="font-xs text-white fw-600 ml-4 mb-0 mt-2">Payment Method</h4>
                            </div>
                                ...
                                <div className="row">
                                            ...
                                            <div className="card-body d-block text-left p-0">
                                                <div className="item w-100 h150 bg-white rounded-xxl overflow-hidden text-left shadow-md pl-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card border-0 shadow-none p-0 bg-transparent-card text-left w-100">
                                                        <div className="row">
                                                            <div className="col-6">
                                                                <img src="https://via.placeholder.com/50x50.png" alt="icon" className="w40 float-left d-inline-block"/>
                                                            </div>
                                                            <div className="col-6 text-right pr-4">
                                                                <img src="https://via.placeholder.com/50x50.png" alt="icon" className="w30 float-right d-inline-block mt-2 mr-2"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="item w-100 h150 bg-gold-gradiant rounded-xxl overflow-hidden text-left shadow-md pl-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6 text-right pr-4">
                                                                <img src="https://via.placeholder.com/50x50.png" alt="icon" className="w30 float-right d-inline-block mt-2 mr-2 rounded-xxl"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="item w-100 h150 bg-primary rounded-xxl text-left shadow-md pl-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div className="row">
                                                            ...
                                                            <div className="col-6 text-right pr-4">
                                                                <img src="https://via.placeholder.com/50x50.png" alt="icon" className="w30 float-right d-inline-block mt-2 mr-2 rounded-lg"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="card bg-transparent border-0 bg-transparent-card shadow-none p-0 text-left w-100 mt-auto">
                                    ...
                                    <div className="col-lg-6 offset-lg-1">
                                        <div className="rounded-xxl bg-greylight h-100 p-3">
                                            <div className="col-lg-12 pl-0">
                                                {/* <!-- <h4 className="mb-4 font-xs fw-700 mont-font mt-0">Add Card </h4> --> */}
                                            </div>
                                            <div className="col-lg-12">
                                                <div className="item ml-auto mr-auto mt-3 w-100 h150 bg-white rounded-xxl text-left shadow-lg pl-3 pt-2 align-items-end flex-column d-flex">
                                                    <div className="card border-0 bg-transparent-card shadow-none p-0 text-left w-100">
                                                        <div className="row">
                                                            <div className="col-6 pl-2">
                                                                <img src="https://via.placeholder.com/50x50.png" alt="icon" className="w60 float-left d-inline-block"/>
                                                            </div>
                                                            <div className="col-6 text-right pr-4">
                                                                <img src="https://via.placeholder.com/50x50.png" alt="icon" className="w30 float-right d-inline-block mt-2 mr-2"/>
                                                            </div>
                                            ...
                                            <div className="col-lg-12 mt-5">
                                                <form>
                                                    <div className="form-group mb-1">
                                                        <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="exampleInputPassword1">Card Number</label>
                                                        <div className="form-group icon-tab">
                                                            <input type="text" className="bg-white font-xsss border-0 rounded-lg form-control pl-4 bg-color-none border-bottom text-grey-900" placeholder="1234 1234 1234 1234"/>                        
                                                        </div>
                                                    </div>
                                                    <div className="form-group mb-1">
                                                        <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="exampleInputPassword1">Card Holder Name</label>
                                                        <div className="form-group icon-tab">
                                                            <input type="text" className="bg-white border-0 rounded-lg form-control pl-4 bg-color-none border-bottom text-grey-900" placeholder="Name"/>                        
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-6">
                                                            <div className="form-group mb-1">
                                                                <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="exampleInputPassword1">Month</label>
                                                                <div className="form-group icon-tab">
                                                                    <input type="text" className="bg-white border-0 rounded-lg form-control pl-4 bg-color-none border-bottom text-grey-900" placeholder="03"/>                        
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-6">
                                                            <div className="form-group mb-1">
                                                                <label className="text-dark-color text-grey-600 font-xssss mb-2 fw-600" htmlFor="exampleInputPassword1">Year</label>
                                                                <div className="form-group icon-tab">
                                                                    <input type="text" className="bg-white border-0 rounded-lg form-control pl-4 bg-color-none border-bottom text-grey-900" placeholder="2021"/>                        
                                                                </div>
                                                            </div>
                                                        </div>
