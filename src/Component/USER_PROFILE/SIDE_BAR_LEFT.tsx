    ...
    return (
        <>
            ...
            <div className="middle-sidebar-left">
                <div className="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden mb-3" style={{ backgroundImage: 'url(https://via.placeholder.com/1200x600.png)' }}>
                ...
                <div className="card d-block w-100 border-0 shadow-xss rounded-lg overflow-hidden mb-4">
                    <ul className="nav nav-tabs xs-p-4 d-flex align-items-center justify-content-between product-info-tab border-bottom-0" id="pills-tab" role="tablist">
                        <li className="active list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 ml-sm-5 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase active" href="#navtabs0" data-toggle="tab">About</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs1" data-toggle="tab">Video</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs2" data-toggle="tab">Badge</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs3" data-toggle="tab">Group</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs4" data-toggle="tab">Friends</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs3" data-toggle="tab">Stream</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs1" data-toggle="tab">Saved</a></li>
                        <li className="list-inline-item"><a className="fw-700 pb-sm-5 pt-sm-5 xs-mb-2 mr-sm-5 font-xssss text-grey-500 ls-3 d-inline-block text-uppercase" href="#navtabs7" data-toggle="tab">LIVE</a></li>
                    </ul>
                </div>
                                    ...
                                    <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6 mb-4">
                                        <div className="card w-100 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-1">
                                            <div className="card-image w-100 mb-3">
                                                <a href="home-3.html" className="video-bttn position-relative d-block"><img src="https://via.placeholder.com/300x200.png" alt="image" className="w-100" /></a>
                                            </div>
                                    ...
                                    <div className="col-xl-4 col-lg-6 col-md-6">
                                        <div className="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                                            ...
                                            <a href="#" className="btn-round-xxxl rounded-lg ml-auto mr-auto">
                                                <img src="https://via.placeholder.com/100x100.png" alt="icon" className="w-100" />
                                            </a>
                                    ...
                                    <div className="col-xl-4 col-lg-6 col-md-6">
                                        <div className="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                                            ...
                                            <a href="#" className="btn-round-xxxl rounded-lg bg-lightblue ml-auto mr-auto">
                                                <img src="https://via.placeholder.com/30x30.png" alt="icon" className="p-1" />
                                            </a>
                                    ...
                                    <div className="col-xl-4 col-lg-6 col-md-6">
                                        <div className="card mb-4 d-block w-100 shadow-xss rounded-lg p-xxl-5 p-4 border-0 text-center">
                                            ...
                                            <a href="#" className="btn-round-xxxl rounded-lg alert-danger ml-auto mr-auto">
                                                <img src="https://via.placeholder.com/30x30.png" alt="icon" className="p-2" />
                                            </a>
